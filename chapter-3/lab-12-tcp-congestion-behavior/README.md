...
concept-notes: ["TCP — Flow Control, Reliable Transfer, & Production Tunables", "TCP Congestion Control"]
---
...
Capture iperf3 traffic and decode TCP congestion-window behavior over time.
