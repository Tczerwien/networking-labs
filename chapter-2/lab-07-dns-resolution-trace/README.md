...
concept-notes: ["DNS — Purpose, Hierarchy, Records", "DNS — Iterative vs Recursive, Caching, Message Format"]
---
...
Capture a DNS resolution sequence and decode every query/response.
